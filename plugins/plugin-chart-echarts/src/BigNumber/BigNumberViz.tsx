...
class BigNumberVis extends React.PureComponent<BigNumberVizProps,modalProps> {
  ...
  render() {
    ...
    return (
      <div className={className} style={{ height }}>
        ...
        {this.state.open && (
          <div>          
            <Modal  title={'Channel Members'} show={this.state.open} onHide={this.closeModal}>
               <TableView columns={this.columns} data={this.data} />
            </Modal>    
        </div>
        )}
